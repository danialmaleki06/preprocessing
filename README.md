...
> **Модель выдаёт 0.95 на тесте, а в проде 0.78?**
> Часто виновата не модель, а **утечка данных** в предобработке: тест незаметно «подсматривает» в обучение через общие медианы, масштабы и границы выбросов.
